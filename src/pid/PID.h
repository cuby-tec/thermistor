...
typedef struct pid_controller * _pid_t;
...
extern "C" {
	 ...
	 */
	_pid_t pid_create(_pid_t pid, float* in, float* out, float* set, float kp, float ki, float kd);
	 ...
	 */
	bool pid_need_compute(_pid_t pid);
	 ...
	 */
	void pid_tune(_pid_t pid, float kp, float ki, float kd);
	 ...
	 */
	void pid_sample(_pid_t pid, uint32_t time);
	 ...
	 */
	void pid_limits(_pid_t pid, float min, float max);
	 ...
	 */
	void pid_direction(_pid_t pid, enum pid_control_directions dir);
